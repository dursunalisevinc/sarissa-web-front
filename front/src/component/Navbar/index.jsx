                    ...
                    <div className="relative flex flex-col gap-4 max-h-[30rem] overflow-auto">
                      ...
                      <div className="sticky bottom-0 flex justify-end p-[1rem] bg-white">
                        <button
                          ...
                          className="bg-white text-rose-500 text-rose-500 px-4 py-2 rounded-full border border-rose-500 hover:bg-rose-50 duration-300 cursor-pointer mx-2"
                        >
                          Sepeti Kaldır
                        </button>
                        <button className="bg-green-500 text-white text-green-500 px-4 py-2 rounded-full hover:bg-green-600 duration-300 cursor-pointer">
                          Sepeti Onayla
                        </button>
                      </div>
                    </div>

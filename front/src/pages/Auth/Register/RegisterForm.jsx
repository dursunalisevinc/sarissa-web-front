  ...
  return (
    <div className="flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl w-full max-w-md">
        {successMsg && (
          <div className="text-green-600 text-center mb-4">{successMsg}</div>
        )}
        {errorMsg && (
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-sm text-orange-500/40 hover:text-orange-400 cursor-pointer hover:bg-slate-50 p-1 rounded-full"
              >
          ...
          <button
            type="submit"
            className="w-full mt-4 bg-green-500 text-white font-medium px-4 py-2 rounded-lg border border-green-200 hover:bg-green-600 duration-300"
          >
            Kayıt Ol
          </button>
        </form>
